  ...
  return (
    ...
    >
      ...
      >
        <div
          ref={preLayersRef}
          className={`sm-prelayers ${isFixed ? 'fixed' : 'absolute'} top-0 right-0 bottom-0 pointer-events-none z-[35]`}
          aria-hidden="true"
        >
          {(() => {
        ...
        <aside
          ...
          ref={panelRef}
          className={`staggered-menu-panel ${isFixed ? 'fixed' : 'absolute'} top-0 right-0 h-full bg-white flex flex-col p-[6em_2em_2em_2em] overflow-y-auto z-40 backdrop-blur-[12px]`}
...
.sm-scope .staggered-menu-header { display: flex; align-items: center; background: transparent; pointer-events: none; z-index: 50; }
